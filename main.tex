...
Apparate zur Darstellung bewegter Zeichnungen existieren bereits seit 1830, doch es ist eine Erfindung \name{Muybridge}s, die die Fotografie mit dem bewegten Bild vereint (\cref{sec:phenakistiskop_zoopraxiskop}), ehe \name{Thomas Edison} die Grundlage für das moderne Multiplex-Kino schafft (\cref{sec:kinetoskop}).

\subsubsection{Vom Phenakistiskop zum Zoopraxiskop}
\label{sec:phenakistiskop_zoopraxiskop}
