...
Bereits in der \textit{Problemata physica} beschreibt Pseudo-\name{Aristoteles} (384-322 v. Chr.) das Phänomen des auf dem Kopf stehenden Bildes, wie es das Licht erzeugt, wenn es durch ein kleines Loch fällt -- einem Effekt, wie man ihn heutzutage etwa an Schlüssellöchern beobachten kann (\cite{CamObs:2015:Online}).
...
In der frühen mittelalterlichen Kunst Europas finden sich Darstellungen der Natur allein in Form von Bildnissen des Kloster- oder Hofgartens, als Nutz- oder Ziergarten. %\todo{Quelle} 
Eine Abbildung der Landschaft außerhalb der Mauern des Klosters oder der Burg schien außer Frage. Obschon die Landschaft in der Malerei der Renaissance bildwichtiger Bestandteil zu werden beginnt, lässt sich noch in \name{Claude Lorrain}s \textit{Die Verstoßung der Hagar} (1668, \cref{fig:verstossung1668}) der Konflikt zwischen der Sicherheit des Innen -- so erdrückend es dort auch erscheint -- und der Ungewissheit des Außen erkennen. 
...
Mit dem goldenen Zeitalter der Niederlande (ca. 1600-1700) beginnt ein exponentieller Zuwachs an Malereien, welche sich von biblischen Themen und den Motiven der Schäferdichtung abwenden, um die Landschaft selbst in den Vordergrund zu rücken. %\todo{Quelle} 
Es ist letztlich die Zeit der Romantik (ca. 1800-1850), in der sich Maler wie \name{Caspar David Friedrich} finden, die mit Werken wie \textit{Der Wanderer über dem Nebelmeer} (1818, \cref{fig:wanderer1818}) die Schroffheit der Natur zum Kunstmotiv, zum Sehenswerten erheben (\cite{LandscapePainting:2015:Online}). %\todo{Bessere Quelle finden}
...
Im 18. und 19. Jahrhundert war die Malerei eines Portraits -- wie auch heute -- ein zeitaufwändiger Akt. %\todo{Wie lange hat Vermeer gebraucht?} 
Entsprechend hoch muss der Preis für ein solches Bild gewesen sein, so dass nur wohlhabende Angehörige des Adels überhaupt in den Genuss eines Portraits ihrer Person kommen konnten; wer sich auf einem Portrait verewigt fand, hatte Geld, war wichtig.
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \end{center}
  \vspace{-20pt}
  \captionsource{Plate 626 in \textit{Animal Locomotion}; Muybridge, 1887}{\cite{AnnieG626:2015:Online}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \end{center}
  \vspace{-20pt}
  \captionsource{Zoopraxiskop; Muybridge, 1879}{\cite{Zoopraxis:2015:Online}}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \end{center}
  \vspace{-20pt}
  \captionsource{Bacigalupi's Kinetoscope and phonograph parlor, Market Street, San Francisco, ca. 1894}{\cite{Bacigalupi:2015:Online}}
...
Es dauert keine vier Jahre bis eine erste Variante mit Tonspur erschien, welche den Ton von einem synchronisierten Wachszylinder abspielte.
Der Andrang auf das neue Medium war so groß, dass nun ganze Kinetoskop-Salons gegründet wurden, wie der in \cref{fig:sanfrancisco1894} dargestellte Salon in San Francisco um ca. 1894, in welchem die Betrachtung eines Filmes den Gast 10 Cent kostete (\cite{Bacigalupi:2015:Online}).
...
\name{Gabriel Lippmann} (1845-1921), seines Zeichens luxemburgischer Physiker, erfindet ein Interferenzverfahren zur fotografischen Farbreproduktion (vgl.~\cref{fig:lippmann1891}), für das er 1886 den Nobelpreis erhält (\cite{Lippmann:2015:Online}). 
...
\begin{wrapfigure}{r}{0.25\textwidth}
  ...
  \end{center}
  \vspace{-20pt}
	\captionsource{Farbreproduktion eines Papageies von Gabriel Lippmann, 1891}{\cite{Lippmann:2015:Online}}
	\label{fig:lippmann1891}
  \vspace{-10pt}
\end{wrapfigure}
%
Weniger bedeutend, aber ungleich eindrucksvoller sind hingegen die Arbeiten \name{Sergey Prokudin-Gorsky}s. Um 1809 der russische Chemiker und Fotograf vom Zaren Nikolas II. beauftragt, das russische Reich fotografisch zu dokumentieren.
...
Wie auch \name{Alfred Stieglitz} (siehe~\cref{sec:foto_kunst}) vertraten diese das Ziel, eine geradlinige, authentische Fotografie -- die \textit{straight photography} -- als Kunst zu etablieren\footnote{Der Name \textit{f/64} ist eine Anspielung auf die Prinzipien: Er beschreibt eine Blendeneinstellung, die maximalmögliche Schärfe und Genauigkeit in den Geräten ihrer Zeit verspricht.} (\cite{GesDerPho:Book}), wobei \name{Adams} jedoch im Gegensatz zu \name{Steiglitz} sehr wohl von den Möglichkeiten der Nachbearbeitung Gebrauch macht.
...
So entfalten etwa die Stadtfotografien \name{Eugène Atget}s, der im Auftrag der Bibliothèque historique de la ville de Paris in den Jahren ab 1906 jene Gebäude fotografiert, die der Pariser Neugestaltung zum Opfer fallen würden, eine ganz eigene Melancholie (\cite{Atget:Book}).
Die Dokumentation des Innenraumes und auch der Suburbia, der Vororte und Gassen unserer Städte, erscheint uns sehr viel näher. 
...
1892 gründete \name{George Eastman}, ein New Yorker Unternehmer, aus seiner Eastman Dry Plate Company die neue Firma \textit{Eastman Kodak Company} in Rochester, New York.
Sein Ziel war es, durch Serienproduktion günstiger Kameras den Massenmarkt zu erreichen.
Die aus dieser Idee entstandene Boxkamera \textit{Kodak Nr. 1} (1888-1895) sollte möglichst einfach zu bedienen und dabei möglichst billig sein. 
Gemäß dem Motto "`You press the button -- we do the rest"' (\cite{PressTheButton:2015:Online}) wurde die Kamera mit einem Film für 100 Aufnahmen vorgeladen und nach vollständiger Belichtung direkt an Kodak zurückgesandt, welche die Entwicklung des Filmes für den Kunden vornahm.
...
Unbestritten ist allerdings die Wirkung auf die Verbreitung der Fotografie, und so produziert Kodak nach und nach weitere Modelle, so etwa die Brownie-Serie ab 1900, die ihren Höhepunkt in den 1950er Jahren findet. 
Der Typus der Boxkamera ist so weit verbreitet, dass er sich bereits 1928 den Namen "`Volkskamera"' (\cite{Volkskamera:2015:Online}) einbringt und damit den Begriff des "`Volksgerätes"' lange Zeit vor dem Volksempfänger (1938, \cite{Volksempfaenger:2015:Online}) und dem Volkswagen (1946, \cite{Volkswagen:2015:Online}) prägt.
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \end{center}
  \vspace{-20pt}
	\captionsource{Hinter dem Bahnhof Saint-Lazare; Henri Cartier-Bresson, 1932}{\cite{HCB:2015:Online}}
...
Die \textit{BILD}-Zeitschrift erschien erstmals im Juni 1952 als Format, das ausschließlich auf großformatige Bilder zur Übermittlung der Nachricht setzte (\cite{Bild:2015:Online}).
...
\begin{figure}[h]
  ...
  \captionsource{Dies ist keine Pfeife: La trahison des images; Magritte 1948}{\cite{Trahison:2015:Online}}
  \label{fig:magritte}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.5\textwidth}
	    ...
	    \captionsource{Musette; Nadar 1855}{\cite{METMusette:2015:Online}}
	...
	\begin{subfigure}[b]{0.36\textwidth}
	    ...
	    \captionsource{La Source; Ingres 1856}{\cite{Quelle:2015:Online}}
	    \label{fig:lasource1856}
	\end{subfigure}%

	\caption{Die Fotografie \textit{Musette} als Vorlage für das Gemälde \textit{La Source}}
\end{figure}
...
\begin{figure}[h]
	...
	\captionsource{Phenakistiskopscheibe; Muybridge, 1893}{\cite{Phenak:2015:Online}}
...
\begin{figure}[h]
	...
	\captionsource{Seyyid Mir Mohammed Alim Khan; Sergey Prokudin-Gorsky, ca. 1911; Projiziertes Gesamtbild (links) und Einzelbilder (rechts).}{\cite{Gorsky:2015:Online}}
...
\begin{figure}[h]
	...
	\captionsource{Armenische Frau; Sergey Prokudin-Gorsky, ca. 1910}{\cite{Armenier:2015:Online}}
...
\begin{figure}[h]
	...
	\captionsource{Leo Tolstoy; Sergey Prokudin-Gorsky, ca. 1908}{\cite{Gorsky:2015:Online}}
...
\begin{figure}[h]
	...
	\captionsource{Farbfoto auf Kodachrome: Salesbury Avenue from Picadilly Circus; Chalmers Butterfield, ca. 1949}{\cite{Piccadilly:2015:Online}}
