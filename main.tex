...
Spätestens mit den Arbeiten \name{Muybridge}s ist der Weg zum Kinofilm geebnet. 
Apparate zur Darstellung bewegter Zeichnungen existieren bereits seit 1830 (\cref{sec:phenakistiskop}), doch es ist eine Erfindung \name{Muybridge}s, die die Fotografie mit dem bewegten Bild vereint (\cref{sec:zoopraxiskop}), ehe \name{Thomas Edison} die Grundlage für das moderne Multiplex-Kino schafft (\cref{sec:kinetoskop}).

\subsubsection{Phenakistiskop}
\label{sec:phenakistiskop}

„Augentäuscher“, ca. 1830 bis 1833
Joseph A. F. \name{Plateau} (1801-1883)

\subsubsection{Zoopraxiskop}
\label{sec:zoopraxiskop}

\name{Muybridge}, 1879

\subsubsection{Kinetoskop}
\label{sec:kinetoskop}
