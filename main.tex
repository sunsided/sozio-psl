...
Wie faszinierend die "`luzide"' Camera Obscura auf den Menschen gewirkt haben muss, zeigt \name{Peter Webber}s Film \textit{Das Mädchen mit dem Perlenohrring} eindrucksvoll\footnote{Ein Ausschnitt zur Camera Obscura ist unter \url{https://youtu.be/P8Xlo1GilbE} zu finden.}. Dabei hatte das Gerät einen entscheidenen Nachteil: Mit dem Licht verschwand auch das Bild. Es sollte nach der Erfindung \name{Zahn}s noch gute anderthalb Jahrhunderte dauern, bis die erste permanente Fotografie im Jahre 1826 das Licht der Welt erblickte.
